...
class EnrollModel extends Model{
    ...
    protected $_validate = array(
       ...
       array('student_number','check_length','学籍号为19位或者必须是2013开头',1,'callback'),
        ...
        array('student_name','require','姓名不能为空',1),
        array('graduation_school','require','毕业学校不能为空',1),
        array('student_duty','require','职务不能为空，没有写无',1),
        array('student_sex','require','性别不能为空',1),
        array('student_race','require','民族不能为空',1),
        array('political_status','require','政治面貌不能为空',1),
        array('student_birth','require','生日不能为空',1),
        array('zipcode','require','邮政编码不能为空'),
        array('student_address','require','通讯地址不能为空'),
        array('contact_number1','require','联系人1不能为空',1),
        array('contact_number2','require','请填写可以联系到您的电话',1),
      ...
      #  array('biologic_score','number','生物分数必须是数字'),
        ...
        array('biologic_level','require','生物级别不能为空',1),
        array('it_level','require','信息技术级别不能为空',1),
        array('guarder1_name','require','第一监护人不能为空',1),
