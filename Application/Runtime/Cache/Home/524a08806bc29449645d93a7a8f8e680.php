...
<!-- Theme style -->
<link href="/login/Public/adminlte/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
<!-- iCheck -->
<link href="/login/Public/adminlte/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
...
<div class="register-box">
    <div class="register-logo">
        <a href="../../index2.html"><b>青岛十七中</b>自主招生网上报名系统</a>
    </div>

    <div class="register-box-body">
        <p class="login-box-msg">注册一个新用户</p>
        <form action="/login/index.php/Home/Login/register.html" method="post">
...
<!-- iCheck -->
<script src="/login/Public/adminlte/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
<script>
    $(function () {
        $('input').iCheck({
